...
class PairingInputService : Service() {
    ...
    companion object {
        ...
        const val ACTION_PAIRING_INPUT = "com.fauzan.nativedex.PAIRING_INPUT"
        const val ACTION_PAIRING_CANCEL = "com.fauzan.nativedex.PAIRING_CANCEL"
        const val ACTION_SUBMIT_CODE = "com.fauzan.nativedex.SUBMIT_PAIRING_CODE"
