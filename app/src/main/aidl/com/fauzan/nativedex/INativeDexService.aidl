...
interface INativeDexService {
     ...
     * @return the displayId of the created virtual display, or -1 if failed.
     */
    int createTrustedVirtualDisplay(in Surface surface, int width, int height, int densityDpi);
