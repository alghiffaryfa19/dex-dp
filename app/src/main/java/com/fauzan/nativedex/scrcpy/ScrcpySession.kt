package com.fauzan.nativedex.scrcpy

import android.content.Context
import android.util.Log
import com.fauzan.nativedex.Adb
...
class ScrcpySession(
    ...
    private val physicalDisplayId: Int,
) {
    sealed class State {
    ...
    private suspend fun runSession() {
        ...
        val command = "CLASSPATH=$SERVER_REMOTE_PATH app_process / com.genymobile.scrcpy.Server " +
            ...
            "turn_screen_off=true display_id=$physicalDisplayId"
        ...
        // Since video=false and audio=false, the first and only socket scrcpy expects is the control socket.
        ...
        // Set state to running directly since we don't wait for video frames
        _state.value = State.Running(0, 0, physicalDisplayId)
    }
    ...
    private fun parseDisplayId(logChunk: String) {
        ...
        scope.launch {
            // We don't need to force freeform here because DisplayMonitorService handles it
            // and we are attaching to an existing physical display.
        }
